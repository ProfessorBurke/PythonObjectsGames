...
class Article(ContentItem):
    """Represent an Article ContentItem.
    ...
    def __init__(self, text) -> None:
        ...
        # Annotate variables
        sys_font: pygame.font.SysFont = pygame.font.SysFont("none",11)
        image: pygame.Surface = sys_font.render(text, True, (0,0,0))
...
def main():
    ...
    niagara: pygame.Surface
    article: Article
    ad: Ad
    page: Page
    lorem: str = "Lorem ipsum dolor sit ametod."
