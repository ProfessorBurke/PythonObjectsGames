...
class Penguin(pygame.sprite.Sprite):
    ...
    def __init__(self, screen: pygame.Surface) -> None:
        ...
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.image.load("sprites/penguin_sheet.png")
...
def main() -> None:
    ...
    image_files: list = ["background/ice_block.jpg", "background/ice_wall.jpg"]
    background = ScrollingBackground(image_files, "background/ice_castle.txt", [0])
